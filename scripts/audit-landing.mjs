...
for (const [w, h, label] of [[320, 700, '320'], [390, 844, '390'], [768, 1024, '768'], [1280, 900, '1280'], [1512, 982, '1512']]) {
  ...
  const r = await page.evaluate(() => {
    ...
    const createBtn = [...document.querySelectorAll('button')].find(b => b.textContent.includes('Start a transfer'));
    const joinBtn = [...document.querySelectorAll('button')].find(b => b.textContent.includes('Already have a code?'));
