...
export function IOSToggle({
  ...
  // Track: iOS system green when on — the universal toggle color. Off is a
  // quiet neutral. (A themed toggle re-learns itself every screen; this one
  // reads instantly, like the platform's own.)
  const trackBg = checked
    ? 'linear-gradient(135deg, #30d158 0%, #34c759 50%, #2aa24a 100%)'
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-azure-600',
      ...
      style={{
        ...
        boxShadow: checked
          ? 'inset 0 2px 4px rgba(0,0,0,0.2), inset 0 -1px 2px rgba(255,255,255,0.15), 0 1px 3px rgba(0,0,0,0.12)'
