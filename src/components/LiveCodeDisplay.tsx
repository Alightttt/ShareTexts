        ...
        <div className="flex gap-2 sm:gap-3 flex-1 justify-end">
          {digits.slice(0, 3).map((digit, i) => (
            <div key={i} className={cn(
              "relative flex items-center justify-center rounded-[10px] sm:rounded-[14px] shadow-sm flex-1 max-w-[80px] aspect-[3/4] sm:w-[64px] sm:h-[90px] sm:max-w-none sm:aspect-auto lg:w-[64px] lg:h-[88px]",
              ...
              <AnimatePresence mode="popLayout">
                <motion.span
                  ...
                  className="text-[56px] sm:text-[52px] lg:text-[52px] font-bold text-apple-ink dark:text-[#f0f2f5] absolute font-mono tnum tracking-tighter"
                >
                  {digit}
                </motion.span>
              </AnimatePresence>
