const en = {
  ...
  // ── landing story (F7) ─────────────────────────────────────────────
  'land.demo.try': 'Try it — pick something to send',
  'land.demo.pick': 'Pick something to send',
  'land.demo.send': 'Send',
  'land.demo.again': 'Send something else',
  'land.demo.demo': 'Demo',
  'land.demo.a': 'This device',
  'land.demo.b': 'Your other device',
  'land.demo.finding': 'Finding',
  'land.demo.connected': 'Connected',
  'land.demo.sending': 'Sending',
  'land.demo.arrived': 'Received',
  'land.demo.sampleText': 'Okay sending the notes now',
  'land.demo.sampleUrl': 'https://en.wikipedia.org/wiki/USB',
  'land.demo.sampleFile': 'holiday-photos.zip · 24 MB',
  'land.demo.hint': 'A demonstration — no transfer happens here. The real thing is one tap away.',
  'land.send.title': 'Text, links, photos, files — whatever is on your mind',
  'land.send.body': 'Type or paste text, drop in files, share a link. If it fits on one device, it moves to the other — in original quality, no compression.',
  'land.send.text': 'Text',
  'land.send.url': 'Links',
  'land.send.image': 'Photos',
  'land.send.file': 'Files',
  'land.send.text.ex': 'Copied addresses, notes, code',
  'land.send.url.ex': 'Open on the big screen',
  'land.send.image.ex': 'Original quality, never resized',
  'land.send.file.ex': 'Any type, several at once',
  'land.flow.title': 'From open to done',
  'land.flow.1': 'Open ShareTexts on both devices',
  'land.flow.2': 'Your other device appears — tap it',
  'land.flow.3': 'Connected. Send — it arrives, ready to use.',
  'land.flow.cta': 'This is the whole thing.',
  'land.both.title': 'It works both ways',
  'land.both.body': 'The phone can send to the PC, and the PC can send right back. Same room, same simplicity — no “upload here, download there”.',
  'land.trust.title': 'Private by how it works, not by policy',
  'land.trust.noaccount': 'No account, no install',
  'land.trust.noaccount.b': 'Open the site on both devices. That is the whole setup.',
  'land.trust.direct': 'Device-to-device, encrypted',
  'land.trust.direct.b': 'Your things move straight between the two devices. The relay fallback only ever forwards encrypted data.',
  'land.trust.temporary': 'Gone when you are done',
  'land.trust.temporary.b': 'Rooms are temporary — they close when you end them and expire on their own. Codes rotate.',
  'land.trust.control': 'Your files stay yours',
  'land.trust.control.b': 'Nothing sits on a server. What you send exists on the two devices, nowhere else.',
  'land.cta.title': 'Ready when you are',
  'land.cta.body': 'Open ShareTexts on your other device and send something.',
  'land.cta.send': 'Send something',
  ...
  'lifetime.title': 'All time on this device',
  'lifetime.connections': 'Connections',
  'lifetime.partners': 'Devices met',
  ...
  'composer.teach': 'Type, paste, drop, or pick a file — everything lands on the other device',
  'composer.teach.type': 'Type',
  'composer.teach.paste': 'Paste',
  'composer.teach.drop': 'Drop a file',
  ...
  'nearby.searchingHint': 'Keep ShareTexts open on your other device',
  ...
  'nearby.failBody': 'Make sure ShareTexts is open on your other device, or use a QR code instead.',
  ...
  'nearby.why2': 'Turn on Nearby visibility on your other device.',
  'nearby.why3': 'Some public, work, or hotel Wi-Fi blocks device-to-device connections.',
